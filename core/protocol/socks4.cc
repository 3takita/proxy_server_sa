...
namespace core::protocol {
    ...
    void Socks4::OnReadable(Connection& connection, EventPollerIdentifier poller) {
        (void)poller;
        ...
        auto& buf = connection.receive_buffer_;
        ...
        auto& send = connection.send_buffer_;
    ...
    void Socks4::OnWritable(Connection& connection, EventPollerIdentifier poller) {
        (void)connection;
        (void)poller;
    }

    bool Socks4::IsEstablished() const {
